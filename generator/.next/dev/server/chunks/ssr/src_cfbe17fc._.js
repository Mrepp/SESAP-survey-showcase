...
function WordCloud() {
    ...
    const wordDataRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Handle resize
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadData() {
            try {
                ...
                transcripts.forEach((transcript)=>{
                    if (Array.isArray(transcript)) {
                        transcript.forEach((wordObj)=>{
                            if (wordObj.w) {
                                allWords.push(wordObj.w);
                            }
                        });
                    } else if (transcript.transcript) {
                        allWords.push(transcript.transcript);
                    }
                });
                // Process words: remove punctuation, convert to lowercase, filter
                const words = allWords.map((word)=>word.toLowerCase().replace(/[^\w]/g, '')).filter((word)=>word.length > 3) // Filter out short words and empty strings
                ;
                ...
                const data = Object.entries(wordCounts).map(([text, value])=>({
                        text,
                        value
    ...
    // Render word cloud when dimensions or data changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (loading || error || !wordDataRef.current) return;
        ...
        const layout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$cloud$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])().size([
            width,
            height
        ]).words(wordDataRef.current.map((d)=>({
                text: d.text,
                size: 10 + d.value * 5 // Scale font size based on frequency
            }))).padding(5).rotate(()=>0).font("Arial").fontSize((d)=>d.size).on("end", draw);
        layout.start();
        function draw(words) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$create$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__create$3e$__ = __turbopack_context__.i("[project]/node_modules/d3-selection/src/create.js [app-ssr] (ecmascript) <export default as create>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$cloud$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/d3-cloud/index.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
;
;
;
function WordCloud({ size = (group)=>group.length, word = (d)=>d, marginTop = 0, marginRight = 0, marginBottom = 0, marginLeft = 0, width = 640, height = 400, maxWords = 250, fontFamily = "sans-serif", fontScale = 15, fill = null, padding = 0, rotate = 0, invalidation// when this promise resolves, stop the simulation
 } = {}) {
    ...
    const svg = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$create$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__create$3e$__["create"]("svg").attr("viewBox", [
        0,
        0,
        width,
        height
...
//# sourceMappingURL=src_cfbe17fc._.js.map