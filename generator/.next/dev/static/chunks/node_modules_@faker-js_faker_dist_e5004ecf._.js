...
"[project]/node_modules/@faker-js/faker/dist/chunk-ZES2MVAN.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@faker-js/faker/dist/chunk-433Y3JE4.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var Ce = ((t)=>(t.Narrowbody = "narrowbody", t.Regional = "regional", t.Widebody = "widebody", t))(Ce || {}), Er = [
    ...
    seat(e = {}) {
        let { aircraftType: r = "narrowbody" } = e, t = Sr[r], n = Tr[r], a = this.faker.number.int({
            min: 1,
            max: t
...
var G = class extends p {
    ...
    hsl(e = {}) {
        let { format: r = "decimal", includeAlpha: t = !1 } = e, n = [
    ...
    colorByCSSColorSpace(e = {}) {
        let { format: r = "decimal", space: t = "sRGB" } = e, n = Array.from({
            length: 3
        }, ()=>this.faker.number.float({
                multipleOf: 1e-4
            }));
        return N(n, r, "color", t);
    }
};
...
var O = class extends p {
    ...
    username(e = {}) {
        let { firstName: r = this.faker.person.firstName(), lastName: t = this.faker.person.lastName(), lastName: n } = e, a = this.faker.helpers.arrayElement([
            ".",
            "_"
    ...
    displayName(e = {}) {
        let { firstName: r = this.faker.person.firstName(), lastName: t = this.faker.person.lastName() } = e, n = this.faker.helpers.arrayElement([
            ".",
            "_"
    ...
    ipv4(e = {}) {
        ...
        let [n, a] = t.split("/"), o = 4294967295 >>> Number.parseInt(a), [s, m, c, u] = n.split(".").map(Number), f = (s << 24 | m << 16 | c << 8 | u) & ~o, k = this.faker.number.int(o), b = f | k;
        return [
            b >>> 24 & 255,
            b >>> 16 & 255,
            b >>> 8 & 255,
...
function D(i, e = i.person.sexType(), r) {
    ...
    if (e === "generic") return t ?? i.helpers.arrayElement([
        n,
        a
    ]) ?? [];
    let o = e === "female" ? n : a;
...
var U = class extends p {
    ...
    fullName(e = {}) {
        let { sex: r = this.faker.helpers.arrayElement([
            "female",
            "male"
        ]), firstName: t = this.firstName(r), lastName: n = this.lastName(r) } = e, a = this.faker.helpers.weightedArrayElement(this.faker.definitions.person.name);
    ...
    sexType(e = {}) {
        ...
        return r ? this.faker.helpers.enumValue(_e) : this.faker.helpers.arrayElement([
            "female",
            "male"
        ]);
    }
...
var P = class extends x {
    ...
    betweens(e) {
        ...
        return this.faker.helpers.multiple(()=>this.between({
            ...
            count: n
        }).toSorted((a, o)=>a.getTime() - o.getTime());
    }
    recent(e = {}) {
...
function Ur(i, e) {
    ...
    switch(n){
        ...
        case void 0:
            break;
        default:
            throw new l(`Expected dot ('.'), open parenthesis ('('), or nothing after function call but got '${n}'`);
    }
    return [
        r + (n === "." ? 2 : 1),
        e.map((a)=>typeof a == "function" ? a(...t) : void 0)
    ];
}
function Kr(i) {
    let e = i.indexOf(")", 1);
...
var B = class extends x {
    ...
    fromRegExp(e) {
        ...
        for(; s != null;){
            ...
            let g;
            s[1] === "." ? g = this.faker.string.alphanumeric(a) : r ? g = this.faker.string.fromCharacters([
                s[1].toLowerCase(),
                s[1].toUpperCase()
            ], a) : g = s[1].repeat(a), e = e.slice(0, s.index) + g + e.slice(s.index + s[0].length), s = o.exec(e);
        }
        ...
        for(s = c.exec(e); s != null;){
            ...
            let Ar = this.multiple(()=>String.fromCodePoint(this.arrayElement(y)), {
                count: a
            }).join("");
    ...
    arrayElements(e, r) {
        ...
        let n = [
            ...e
        ], a = e.length, o = a - t, s, m;
        for(; a-- > o;)m = this.faker.number.int(a), s = n[m], n[m] = n[a], n[a] = s;
        return n.slice(o);
    }
    enumValue(e) {
        let r = Object.keys(e).filter((n)=>Number.isNaN(Number(n))), t = this.arrayElement(r);
        return e[t];
    }
    rangeToNumber(e) {
    ...
    fake(r) {
        ...
        if (t === -1 || n === -1) return r;
        let o = r.substring(t + 2, n + 2).replace("}}", "").replace("{{", ""), s = Ue(o, this.faker), m = String(s), c = r.substring(0, t) + m + r.substring(n + 2);
        return this.fake(c);
    }
};
var v = class extends x {
    ...
    nearbyGPSCoordinate(e = {}) {
        ...
        let a = this.faker.number.float({
            max: 2 * Math.PI,
            fractionDigits: 5
        }), o = n ? t : t * 1.60934, m = this.faker.number.float({
            max: o,
            fractionDigits: 3
        }) * .995, c = 4e4 / 360, u = m / c, h = [
            r[0] + Math.sin(a) * u,
            r[1] + Math.cos(a) * u
        ];
    ...
    zipCode(r = {}) {
        ...
        return typeof n == "string" && (n = [
            n
        ]), n = this.faker.helpers.arrayElement(n), this.faker.helpers.replaceSymbols(n);
    }
    city() {
...
var W = class extends x {
    ...
    bigInt(e = {}) {
        ...
        let s = o - a + 1n, m = BigInt(this.faker.string.numeric({
...
function ze(i, e) {
    let r = e.valueOf(), n = Math.max(r, 0).toString(16).padStart(12, "0").slice(-12), a = [
        n.substring(0, 8),
        n.substring(8)
    ].join("-"), o = "7xxx-yxxx-xxxxxxxxxxxx".replaceAll("x", ()=>i.number.hex({
            min: 0,
            max: 15
        })).replaceAll("y", ()=>i.number.hex({
            min: 8,
...
var Z = [
    ...
    fromCharacters(e, r = 1) {
        ...
        if (typeof e == "string" && (e = [
            ...e
        ]), e.length === 0) throw new l("Unable to generate string: No characters to select from.");
...
var Yr = {
    ...
    upc(e = {}) {
        ...
        let t = 11 - r.length, n = this.faker.string.numeric({
            length: t,
            allowLeadingZeros: !0
        }), a = `${r}${n}`, o = Ze(a);
        return `${a}${o}`;
...
var ne = class extends p {
    ...
    bitcoinAddress(e = {}) {
        let { type: r = this.faker.helpers.enumValue(be), network: t = "mainnet" } = e, n = Pe[r], a = n.prefix[t], o = this.faker.number.int(n.length), s = this.faker.string.alphanumeric({
            length: o - a.length,
            casing: n.casing,
            exclude: n.exclude
        });
...
var Jr = "\xA0", ie = class extends p {
    ...
    commitEntry(e = {}) {
        let { merge: r = this.faker.datatype.boolean({
            probability: .2
        }), eol: t = "CRLF", refDate: n } = e, a = [
            `commit ${this.faker.git.commitSha()}`
        ];
        r && a.push(`Merge: ${this.commitSha({
            length: 7
        })} ${this.commitSha({
            length: 7
        })}`);
        ...
        u = u.replaceAll(/^[.,:;"\\']|[<>\n]|[.,:;"\\']$/g, ""), a.push(`Author: ${u} <${h}>`, `Date: ${this.commitDate({
            refDate: n
        })}`, "", `${Jr.repeat(4)}${this.commitMessage()}`, "");
        let f = t === "CRLF" ? `\r
` : `
`;
        return a.join(f);
...
var se = class extends p {
    ...
    dataUri(e = {}) {
        let { width: r = this.faker.number.int({
            ...
            min: 1,
            max: 3999
        }), color: n = this.faker.color.rgb(), type: a = this.faker.helpers.arrayElement([
            "svg-uri",
            "svg-base64"
        ]) } = e, o = `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" baseProfile="full" width="${r}" height="${t}"><rect width="100%" height="100%" fill="${n}"/><text x="${r / 2}" y="${t / 2}" font-size="20" alignment-baseline="middle" text-anchor="middle" fill="white">${r}x${t}</text></svg>`;
...
var Xr = [
    ...
    fileName(e = {}) {
        let { extensionCount: r = 1 } = e, t = this.faker.word.words().toLowerCase().replaceAll(/\W/g, "_"), n = this.faker.helpers.multiple(()=>this.fileExt(), {
            count: r
        }).join(".");
    ...
    cron(e = {}) {
        let { includeYear: r = !1, includeNonStandard: t = !1 } = e, n = [
...
"[project]/node_modules/@faker-js/faker/dist/chunk-MVUZLZE2.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$ZES2MVAN$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@faker-js/faker/dist/chunk-ZES2MVAN.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$433Y3JE4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@faker-js/faker/dist/chunk-433Y3JE4.js [app-client] (ecmascript)");
;
;
var f = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$433Y3JE4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"]({
    locale: [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$ZES2MVAN$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$433Y3JE4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["o"]
    ]
});
;
}),
"[project]/node_modules/@faker-js/faker/dist/chunk-MVUZLZE2.js [app-client] (ecmascript) <export a as faker>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "faker",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$MVUZLZE2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$chunk$2d$MVUZLZE2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@faker-js/faker/dist/chunk-MVUZLZE2.js [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=node_modules_%40faker-js_faker_dist_e5004ecf._.js.map