...
function WordCloud({ size = (group)=>group.length, word = (d)=>d, marginTop = 0, marginRight = 0, marginBottom = 0, marginLeft = 0, maxWords = 250, fontFamily = "sans-serif", fontScale = 15, fill = null, padding = 0, rotate = 0, invalidation// when this promise resolves, stop the simulation
    ...
    const cloudLayoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Handle resize
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WordCloud.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WordCloud.useEffect": ()=>{
            ...
            cloudLayoutRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$cloud$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])().size([
                width - marginLeft - marginRight,
                height - marginTop - marginBottom
            ]).words(data).padding(padding).rotate(rotate).font(fontFamily).fontSize({
                "WordCloud.useEffect": (d)=>Math.sqrt(d.size) * fontScale
            }["WordCloud.useEffect"]).on("word", {
                "WordCloud.useEffect": ({ size, x, y, rotate, text })=>{
                    g.append("text").datum(text).attr("font-size", size).attr("fill", fill).attr("transform", `translate(${x},${y}) rotate(${rotate})`).text(text);
                }
            }["WordCloud.useEffect"]).on("end", {
                "WordCloud.useEffect": ()=>{
                // Layout complete
                }
            }["WordCloud.useEffect"]);
...
_s(WordCloud, "kBD88kMpCZwGerzRiG2seuV1h4Y=");
_c = WordCloud;
const text = `I am happy to join with you today in what will go down in history as the greatest demonstration for freedom in the history of our nation.
...
//# sourceMappingURL=src_04e8393f._.js.map