...
"[project]/src/components/visualizations/BarChartPlot.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BarChart.useEffect": ()=>{
            ...
            const flatData = data.flatMap({
                "BarChart.useEffect.flatData": (item)=>Object.entries(item.themes).map({
                        "BarChart.useEffect.flatData": ([theme, value])=>({
                                identity: item.identity,
                                theme: theme,
                                value: value
                            })
                    }["BarChart.useEffect.flatData"])
            }["BarChart.useEffect.flatData"]);
            const plot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$plot$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["plot"]({
                ...
                marks: [
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$marks$2f$bar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barX"](flatData, {
                        x: "value",
                        y: "identity",
                        fill: "theme",
                        sort: {
        ...
        })*/ const d = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"](plot).append("foreignObject").attr("width", 280).attr("height", 200).attr("x", 650).attr("y", 120).append("xhtml:div").html(`
...
_s(BarChart, "8puyVO4ts1RhCfXUmci3vLI3Njw=");
_c = BarChart;
const data = [
    {
        identity: 'Disabled',
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$visualizations$2f$BarChartPlot$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/visualizations/BarChartPlot.jsx [app-client] (ecmascript)");
'use client';
;
;
;
...
//# sourceMappingURL=src_6056d63d._.js.map