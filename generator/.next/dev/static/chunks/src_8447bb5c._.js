...
"[project]/src/components/visualizations/ex.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WordCloud({ width = window.innerWidth, height = 200 }) {
    ...
    const [wordData, setWordData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WordCloud.useEffect": ()=>{
            ...
            const loadData = {
                "WordCloud.useEffect.loadData": async ()=>{
                    try {
                        const allWords = [];
                        // Load stopwords
                        ...
                        try {
                            ...
                            if (stopwordsResponse.ok) {
                                ...
                                stopwords = new Set(stopwordsText.split('\n').map({
                                    "WordCloud.useEffect.loadData": (w)=>w.trim().toLowerCase()
                                }["WordCloud.useEffect.loadData"]).filter({
                                    "WordCloud.useEffect.loadData": (w)=>w && !w.startsWith('#')
                                }["WordCloud.useEffect.loadData"]));
                            }
                        } catch (err) {
                        ...
                        .filter({
                            "WordCloud.useEffect.loadData.wordsFromText": (word)=>word && word.length > 2 && !stopwords.has(word)
                        }["WordCloud.useEffect.loadData.wordsFromText"]) // Filter short words and stopwords
                        ;
                        ...
                        const wordCounts = {};
                        allWords.forEach({
                            "WordCloud.useEffect.loadData": (word)=>{
                                wordCounts[word] = (wordCounts[word] || 0) + 1;
                            }
                        }["WordCloud.useEffect.loadData"]);
                        // Convert to array format for d3-cloud
                        const words = Object.entries(wordCounts).map({
                            "WordCloud.useEffect.loadData.words": ([text, size])=>({
                                    text,
                                    size
                                })
                        }["WordCloud.useEffect.loadData.words"]).sort({
                            "WordCloud.useEffect.loadData.words": (a, b)=>b.size - a.size
                        }["WordCloud.useEffect.loadData.words"]).slice(0, 100) // Top 100 words
                        ;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WordCloud.useEffect": ()=>{
            ...
            const layout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$cloud$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])().size([
                ...
                "WordCloud.useEffect.layout": (d)=>({
                        text: d.text,
                        size: d.size
                    })
            }["WordCloud.useEffect.layout"])).padding(5).rotate(0) // Random rotation: 0 or 90
            .font("Arial").fontSize({
                "WordCloud.useEffect.layout": (d)=>Math.sqrt(d.size) * 10
            }["WordCloud.useEffect.layout"]).on("end", draw);
            layout.start();
            function draw(words) {
                ...
                g.selectAll("text").data(words).enter().append("text").style("font-size", {
                    "WordCloud.useEffect.draw": (d)=>`${d.size}px`
                }["WordCloud.useEffect.draw"]).style("font-family", "Arial, sans-serif").style("fill", {
                    "WordCloud.useEffect.draw": (d, i)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$scale$2d$chromatic$2f$src$2f$categorical$2f$category10$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__schemeCategory10$3e$__["schemeCategory10"][i % 10]
                }["WordCloud.useEffect.draw"]).attr("text-anchor", "middle").attr("transform", {
                    "WordCloud.useEffect.draw": (d)=>`translate(${d.x},${d.y})rotate(${d.rotate})`
                }["WordCloud.useEffect.draw"]).text({
                    "WordCloud.useEffect.draw": (d)=>d.text
                }["WordCloud.useEffect.draw"]);
            }
        }
    }["WordCloud.useEffect"], [
        wordData,
...
_s(WordCloud, "q3FIaAfNzuDfYy/Gnbbua+LyGxw=");
_c = WordCloud;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$visualizations$2f$ex$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/visualizations/ex.jsx [app-client] (ecmascript)");
'use client';
;
;
;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$components$2f$box$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box"], {
                ...
                marginLeft: "-20px",
                marginRight: "-20px",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$visualizations$2f$ex$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=src_8447bb5c._.js.map