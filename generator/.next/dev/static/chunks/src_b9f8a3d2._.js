...
"[project]/src/app/interviews/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Interviews() {
    ...
    const [sortBy, setSortBy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('name-asc') // 'date-asc' (oldest), 'date-desc' (newest), 'name-asc', 'name-desc'
    ;
    ...
    const sortedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Interviews.useMemo[sortedData]": ()=>{
            const sorted = [
                ...data
            ];
            if (sortBy === 'name-asc') {
                sorted.sort({
                    "Interviews.useMemo[sortedData]": (a, b)=>a.name.localeCompare(b.name)
                }["Interviews.useMemo[sortedData]"]);
            } else if (sortBy === 'name-desc') {
                sorted.sort({
                    "Interviews.useMemo[sortedData]": (a, b)=>b.name.localeCompare(a.name)
                }["Interviews.useMemo[sortedData]"]);
            } else if (sortBy === 'date-asc') {
                sorted.sort({
                    "Interviews.useMemo[sortedData]": (a, b)=>new Date(a.date) - new Date(b.date)
                }["Interviews.useMemo[sortedData]"]);
            } else if (sortBy === 'date-desc') {
                sorted.sort({
                    "Interviews.useMemo[sortedData]": (a, b)=>new Date(b.date) - new Date(a.date)
                }["Interviews.useMemo[sortedData]"]);
            }
            return sorted;
        }
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$components$2f$menu$2f$namespace$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Menu$3e$__["Menu"].Trigger, {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$components$2f$button$2f$button$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        children: [
                                            "Sort by: ",
                                            sortBy === 'name-asc' ? 'Name (A to Z)' : sortBy === 'name-desc' ? 'Name (Z to A)' : sortBy === 'date-asc' ? 'Date (Oldest)' : 'Date (Newest)'
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/interviews/page.jsx",
                                        lineNumber: 71,
...
_s(Interviews, "AatvAEemsiUeSHotgpZn/YbhEXM=");
_c = Interviews;
var _c;
...
//# sourceMappingURL=src_b9f8a3d2._.js.map