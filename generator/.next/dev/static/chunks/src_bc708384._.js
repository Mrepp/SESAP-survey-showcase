...
"[project]/src/components/visualizations/BarChartD3.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/d3/src/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__ = __turbopack_context__.i("[project]/node_modules/d3-selection/src/select.js [app-client] (ecmascript) <export default as select>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$array$2f$src$2f$union$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__union$3e$__ = __turbopack_context__.i("[project]/node_modules/d3-array/src/union.js [app-client] (ecmascript) <export default as union>");
...
const data = [
    {
        identity: 'Disabled',
        themes: {
            academicDifficulty: 1,
            belonging: 2,
            careerPrepartion: 3,
            culturalRepresentation: 4,
            facultySupport: 5,
            familyPressure: 6,
            financialStruggles: 7,
            identityDiscrimination: 8,
            mentalHealth: 9,
            languageBarriers: 10,
            peerRelationships: 11,
            personalGrowth: 12,
            supportNetworks: 13,
            workLifeBalance: 14
        }
...
function BarChart() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BarChart.useEffect": ()=>{
            ...
            const themeKeys = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$array$2f$src$2f$union$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__union$3e$__["union"](data.flatMap({
                "BarChart.useEffect.themeKeys": (d)=>Object.keys(d.themes)
            }["BarChart.useEffect.themeKeys"]));
            // Transform data into format suitable for d3.stack
            // Each item has identity and all theme values as properties
            const transformedData = data.map({
                "BarChart.useEffect.transformedData": (d)=>{
                    const item = {
                        identity: d.identity
                    };
                    Object.entries(d.themes).forEach({
                        "BarChart.useEffect.transformedData": ([key, value])=>{
                            item[key] = value;
                        }
                    }["BarChart.useEffect.transformedData"]);
                    return item;
                }
            }["BarChart.useEffect.transformedData"]);
            // Determine the series that need to be stacked.
            const series = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$shape$2f$src$2f$stack$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__stack$3e$__["stack"]().keys(themeKeys) // distinct theme keys, in input order
            .value({
                "BarChart.useEffect.series": (d, key)=>d[key] || 0
            }["BarChart.useEffect.series"]) // get value for each theme key and stack
            (transformedData);
            // Compute the height from the number of identities.
            const height = transformedData.length * 25 + marginTop + marginBottom;
            // Prepare the scales for positional and color encodings.
            const x = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$scale$2f$src$2f$linear$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__scaleLinear$3e$__["scaleLinear"]().domain([
                0,
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$array$2f$src$2f$max$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__max$3e$__["max"](series, {
                    "BarChart.useEffect.x": (d)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$array$2f$src$2f$max$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__max$3e$__["max"](d, {
                            "BarChart.useEffect.x": (d)=>d[1]
                        }["BarChart.useEffect.x"])
                }["BarChart.useEffect.x"])
            ]).range([
                marginLeft,
                width - marginRight
            ]);
            const y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$scale$2f$src$2f$band$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__scaleBand$3e$__["scaleBand"]().domain(transformedData.map({
                "BarChart.useEffect.y": (d)=>d.identity
            }["BarChart.useEffect.y"])).range([
                marginTop,
                height - marginBottom
            ]).padding(0.08);
            const color = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$scale$2f$src$2f$ordinal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__scaleOrdinal$3e$__["scaleOrdinal"]().domain(series.map({
                "BarChart.useEffect.color": (d)=>d.key
            }["BarChart.useEffect.color"])).range(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$scale$2d$chromatic$2f$src$2f$categorical$2f$observable10$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__schemeObservable10$3e$__["schemeObservable10"]).unknown("#ccc");
            // A function to format the value in the tooltip.
            const formatValue = {
                "BarChart.useEffect.formatValue": (x)=>isNaN(x) ? "N/A" : x.toLocaleString("en")
            }["BarChart.useEffect.formatValue"];
            // Select the SVG container.
            const svg = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"](svgRef.current).attr("width", width).attr("height", height).attr("viewBox", [
                0,
                0,
                width,
                height
            ...
            svg.append("g").selectAll().data(series).join("g").attr("fill", {
                "BarChart.useEffect": (d)=>color(d.key)
            }["BarChart.useEffect"]).selectAll("rect").data({
                "BarChart.useEffect": (D)=>D.map({
                        "BarChart.useEffect": (d)=>(d.key = D.key, d)
                    }["BarChart.useEffect"])
            }["BarChart.useEffect"]).join("rect").attr("x", {
                "BarChart.useEffect": (d)=>x(d[0])
            }["BarChart.useEffect"]).attr("y", {
                "BarChart.useEffect": (d)=>y(d.data.identity)
            }["BarChart.useEffect"]).attr("height", y.bandwidth()).attr("width", {
                "BarChart.useEffect": (d)=>x(d[1]) - x(d[0])
            }["BarChart.useEffect"]).append("title").text({
                "BarChart.useEffect": (d)=>`${d.data.identity} ${d.key}\n${formatValue(d[1] - d[0])}`
            }["BarChart.useEffect"]);
            // Append the horizontal axis.
            svg.append("g").attr("transform", `translate(0,${marginTop})`).call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$axis$2f$src$2f$axis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axisTop"](x).ticks(width / 100, "s")).call({
                "BarChart.useEffect": (g)=>g.selectAll(".domain").remove()
            }["BarChart.useEffect"]);
            // Append the vertical axis.
            svg.append("g").attr("transform", `translate(${marginLeft},0)`).call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$axis$2f$src$2f$axis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axisLeft"](y).tickSizeOuter(0)).call({
                "BarChart.useEffect": (g)=>g.selectAll(".domain").remove()
            }["BarChart.useEffect"]);
        }
    }["BarChart.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
        ...
        fileName: "[project]/src/components/visualizations/BarChartD3.jsx",
        lineNumber: 114,
        columnNumber: 12
    }, this);
}
_s(BarChart, "89Ty783ABEwsfMbSOeu9vscWF34=");
_c = BarChart;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$visualizations$2f$BarChartD3$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/visualizations/BarChartD3.jsx [app-client] (ecmascript)");
'use client';
;
;
;
...
function Insights() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$visualizations$2f$BarChartD3$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/src/app/insights/page.jsx",
                lineNumber: 17,
                columnNumber: 13
            }, this)
...
//# sourceMappingURL=src_bc708384._.js.map