...
export default function WordCloud({
    ...
    const cloudLayoutRef = useRef(null)
    ...
    }, [dimensions, size, word, marginTop, marginRight, marginBottom, marginLeft, maxWords, fontFamily, fontScale, fill, padding, rotate, invalidation])
